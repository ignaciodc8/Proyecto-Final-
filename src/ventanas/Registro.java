...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNombre.setBorder(javax.swing.BorderFactory.createTitledBorder("Nombre de usuario"));

        txtPassField.setToolTipText("");
        txtPassField.setBorder(javax.swing.BorderFactory.createTitledBorder("Contraseña"));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(94, 94, 94)
                        .addComponent(botonReg, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(botonReg, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
        );
    ...
    private void botonRegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRegActionPerformed
        ...
        if (userName.isEmpty() || dni.isEmpty() || password.isEmpty()) {
        
            JOptionPane.showMessageDialog(null, "¡Hay campos vacíos!");
        } else {
            try {
            String query = "INSERT INTO usuarios (nombreusuario, documento, clave) VALUES ('"+userName+"', '"+dni+"', '"+password+"')";
